...
//   {
//       type: 'OAuth2',
//       clientId: '000000000000-xxx.apps.hotmailusercontent.com',
//       clientSecret: 'XxxxxXXxX0xxxxxxxx0XXxX0'
//   }
// });
// var pocketcollege_send_email=function(email_recipient,email_subject,email_content)
// {
//   var email1=
//   {
//     from: '"Alex Zhao & Kevin Peng" <pocketcollege@hotmail.com>',
//     to: email_recipient,
//     subject: email_subject,
//     text: email_content,
//     auth: 
//     {
//         user: 'pocketcollege@hotmail.com',
//         refreshToken: '1/XXxXxsss-xxxXXXXXxXxx0XXXxxXXx0x00xxx',
//         accessToken: 'ya29.Xx_XX0xxxxx-xX0X0XxXXxXxXXXxX0x',
//         expires: 1484314697598
//     }
//   };
//   transporter.sendMail(email1,function(err)
//   {
//     if(err)
//     {
...
{
  //pocketcollege_send_email(req.body.email,'PocketCollege--ValidationCode','YourValidationCode');
  ...
  if(!req.cookies.email)
    ...
    MongoClient.connect(url, function(err, db)
    {
      ...
      else 
      {
        ...
        time=(parseInt(req.body.year)*100+time)*100+parseInt(req.body.date);//time(int)===yyyymmdd
        var event1 = {event: req.body.event, time: time, timestr: req.body.month+" "+req.body.date+", "+req.body.year,
...
app.post('/modifytimeline_process',function(req,res)
{
  ...
  MongoClient.connect(url, function(err, db)
  {
    ...
    else 
    {
      ...
      time=(parseInt(req.body.year)*100+time)*100+parseInt(req.body.date);
      var event1 = {event: req.body.event, time: time, timestr: req.body.month+" "+req.body.date+", "+req.body.year,
                    detail: req.body.detail };
      var collection = db.collection('users');
